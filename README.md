...
![App Screenshot](https://raw.githubusercontent.com/amantamboli/portfolio/master/assets/img/devpos/voting.png)
...
Next set the environment variable: (not necessary you can directly put external DNS in `frontend-deployment.yaml` file)
